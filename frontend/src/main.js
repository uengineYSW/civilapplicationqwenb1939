...
pluralCaseList.push( {plural: "applicationProcessings/applications", pascal: "ApplicationProcessingApplication"} )

pluralCaseList.push( {plural: "dataCollections/dataCollectors", pascal: "DataCollectionDataCollector"} )

pluralCaseList.push( {plural: "documentIssuances/pdfDocuments", pascal: "DocumentIssuancePdfDocument"} )
pluralCaseList.push( {plural: "documentIssuances/electronicSignatures", pascal: "DocumentIssuanceElectronicSignature"} )
