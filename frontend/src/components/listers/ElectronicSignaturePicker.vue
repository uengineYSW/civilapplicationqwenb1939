...
<script>
    ...
    export default {
        name: 'DocumentIssuanceElectronicSignaturePicker',
        props: {
        ...
        async created() {
            ...
            if(temp.data) {
                me.list = temp.data._embedded.electronicSignatures;
            }

            if(me.value && typeof me.value == "object" && Object.values(me.value)[0]) {
                var id = Object.values(me.value)[0];
                var tmpValue = await axios.get(axios.fixUrl('/electronicSignatures/' + id))
                if(tmpValue.data) {
