...
import ApplicationList from 'pages/ApplicationProcessing/ApplicationList';
import ApplicationDetail from 'pages/ApplicationProcessing/ApplicationDetail';
import ApplicationEdit from 'pages/ApplicationProcessing/ApplicationEdit';
...
const SecondRoutes = () => {
  ...
  return (
    <>
      <EgovHeader />
      <Routes>
          <Route path="/ApplicationProcessing/applications" element={<ApplicationList />} />
          <Route path="/ApplicationProcessing/ApplicationEdit" element={<ApplicationEdit />} />
          <Route path="/ApplicationProcessing/ApplicationDetail" element={<ApplicationDetail />} />

          <Route path="/DataCollection/dataCollectors" element={<DataCollectorList />} />
          ...
          <Route path="/DocumentIssuance/ElectronicSignatureDetail" element={<ElectronicSignatureDetail />} />
