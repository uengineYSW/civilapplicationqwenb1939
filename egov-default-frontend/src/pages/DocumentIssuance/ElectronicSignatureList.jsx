...
function EgovNoticeList(props) {
    ...
    const retrieveList = useCallback((searchCondition) => {
        ...
        const retrieveListURL = '/electronicSignatures';
        ...
        EgovNet.requestFetch(retrieveListURL,
            ...
            (resp) => {
                ...
                for(let i = 0; i< resp.length; i++){
                    ...
                    mutListTag.push(
                        <Link
                            to={{pathname: "/electronicSignature/ElectronicSignatureDetail"}}
                            state={{
                        ...
                        <div className="condition">
                            <ul>
                                ...
                                <li className="third_2 R">
                                    ...
                                    <li>
                                        <Link to="/documentIssuance/ElectronicSignatureEdit" state={{bbsId: bbsId}} className="btn btn_blue_h46 pd35">등록</Link>
                                    </li>
                            </ul>
                        </div>
                        {/* <!--// 검색조건 --> */}
