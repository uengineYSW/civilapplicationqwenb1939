...
function EgovNoticeList(props) {
    ...
    const retrieveList = useCallback((searchCondition) => {
        ...
        const retrieveListURL = '/applications';
        ...
        EgovNet.requestFetch(retrieveListURL,
            ...
            (resp) => {
                ...
                for(let i = 0; i< resp.length; i++){
                    ...
                    mutListTag.push(
                        <Link
                            to={{pathname: "/application/ApplicationDetail"}}
                            state={{
                ...
                <div className="layout">
                    ...
                    <div className="contents NOTICE_LIST" id="contents">
                        ...
                        <div className="top_tit">
                            <h1 className="tit_1">민원신청 프로세스</h1>
                        </div>

                        <h2 className="tit_2">신청서</h2>
                        ...
                        <div className="condition">
                            <ul>
                                ...
                                <li className="third_2 R">
                                    ...
                                    <li>
                                        <Link to="/applicationProcessing/ApplicationEdit" state={{bbsId: bbsId}} className="btn btn_blue_h46 pd35">등록</Link>
                                    </li>
                            </ul>
                        </div>
                        {/* <!--// 검색조건 --> */}
